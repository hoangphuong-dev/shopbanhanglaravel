      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              @php if($cate_pro->category_status==0) {  @endphp
            ...
            <td>
              ...
              <a onclick="return confirm('Bạn có chắc muốn xoá sản phẩm này ko ?')" href="{{URL::to('/delete-category-product/'.$cate_pro->category_id)}}" class="active" ui-toggle-class="">
