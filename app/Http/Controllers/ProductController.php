...
class ProductController extends Controller
{
	...
	public function save_product(Request $request) {
		...
		if($get_image) {
			...
			$new_image = $name_image.rand(0,99).'.'.$get_image->getClientOriginalExtension(); // rand : sinh ngẫu nhiên tên ảnh từ 0 -> 99
	...
	public function product_detail($product_id) {
		...
		return view('pages.product.show-product-detail')->with('category', $cate_product)->with('brand', $brand_product)->with('product_detail', $product_detail)->with('related_product', $related_product);
	}
}
