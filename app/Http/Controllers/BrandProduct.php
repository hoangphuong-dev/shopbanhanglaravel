...
class BrandProduct extends Controller
{
	...
	public function show_brand_home($brand_id) {
		...
		return view('pages.brand.show-brand')->with('category', $cate_product)->with('brand', $brand_product)->with('brand_by_id', $brand_by_id)->with('brand_name', $brand_name);
	} 
